...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * | ESC  |   Q  |   W  |   E  |   R  |   T  | Home |                    |PageUp|   Y  |   U  |   I  |   O  |   P  | Bksp |
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * | C_TAB|   A  |   S  |   D  |   F  |   G  | End  |                    |PageDn|   H  |   J  |   K  |   L  |   ;  |  '   |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  | Space|                    |Enter |   N  |   M  |   ,  |   .  |  Up  |  /   |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |Adjust|  GUI |  ALt | Henk |||||||| Lower| Space|Space |||||||| Enter|Enter | Raise|||||||| Henk | Left | Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
   ...
   * |  ~   |   !  |   @  |   #  |   $  |   %  |   ^  |                    |   &  |   *  |   (  |   )  |   _  |   +  |  "   |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   z  |   x  |   |  |   [  |   ]  |Pscrn |                    |Pscrn |   {  |   }  |   <  |   >  |  Up  |  ?   |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | Caps |  GUI |  ALt | Mhen |||||||| Lower| Space|Space |||||||| Enter|Enter | Raise|||||||| Mhen | Left | Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_LOWER] = LAYOUT(
