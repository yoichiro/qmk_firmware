...
//+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
                              _______, LOWER,   _______, _______, _______, KC_DEL,  RAISE,   _______                             \
//+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
  ),
...
//+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
                              _______, LOWER,   KC_BSPC, _______, _______, _______, RAISE,   _______                             \
//+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
  ),
...
//+--------+--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+--------+
   _______, _______, BL_TOGG, BL_BRTG, BL_INC,  BL_DEC,                    KC_WH_U, KC_BTN1, KC_MS_U, KC_BTN2, _______, _______, \
//+--------+--------+--------+--------+--------+--------+                 +--------+--------+--------+--------+--------+--------+
   _______, _______, VOLDOWN, VOLUP,   KC__MUTE, _______,                  KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, \
//+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
