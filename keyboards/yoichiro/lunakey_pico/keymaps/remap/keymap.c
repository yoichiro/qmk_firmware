// Copyright 2026 Yoichiro Tanaka (@yoichiro)
// SPDX-License-Identifier: GPL-2.0-or-later
//
// Initial keymap for Remap-enabled firmware. Once flashed, the running
// keymap can be edited from the Remap web client and persists in EEPROM.
